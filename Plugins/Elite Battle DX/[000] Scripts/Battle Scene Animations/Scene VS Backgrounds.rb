...
#===============================================================================
def checkForTrainerVariant(files, trainerid, evilteam = true, teamskull = false, teamNoise = false)
  for i in 0...files.length
	...
	files[i] = nos if pbResolveBitmap(nos) && TeamNoise
...
class SunMoonDefaultBackground
  ...
  def initialize(viewport, trainerid, evilteam = false, teamskull = false, teamNoise = false)
    @viewport = viewport
    @trainerid = trainerid
    @evilteam = evilteam
	@teamNoise = teamNoise
    ...
    files = checkForTrainerVariant(files, trainerid, @evilteam, @teamskull, @teamNoise)
...
class SunMoonEliteBackground
  ...
  def initialize(viewport, trainerid, evilteam = false, teamskull = false, teamNoise = false)
    ...
    # gets specific graphics
    bg = checkForTrainerVariant(bg, trainerid, @evilteam, @teamskull, @teamNoise)
    # creates the background
